...
import com.infusiblecoder.allinonevideodownloader.tiktok_methods.TikTokDownloadCloudBypassWebview_method_6;
                                        ...
                                        AndroidNetworking.get("http://api2.musical.ly/aweme/v1/aweme/detail/?aweme_id=" + location.split("/")[5].split("\\?")[0])
                                                ...
                                                .getAsJSONObject(new JSONObjectRequestListener() {
                                                    ...
                                                    public void onError(ANError error) {
                                                        ...
                                                        AndroidNetworking.get("https://youtube4kdownloader.com/ajax/getLinks.php?video=" + finalUrl2 + "&rand=ORMMQRNNPPTNQPR")
                                                                .setPriority(Priority.MEDIUM)
                                                                .addHeaders("Accept", "*/*")
                                                                ...
                                                                .addHeaders("Host", "youtube4kdownloader.com")
                                                                .addHeaders("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36")
                                                                .build()
                                                                .getAsJSONObject(new JSONObjectRequestListener() {
                                                                    @Override
                                                                    public void onResponse(JSONObject response) {
                                ...
                                mytiktok_get_thread = new Thread() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            ...
                                            if (document.getJSONObject("links").has("hd") && !document.getJSONObject("links").getString("hd").equals("")) {
                                            ...
                                            } else if (document.getJSONObject("links").has("sd") && !document.getJSONObject("links").getString("sd").equals("")) {
                                                String nametitle = "Facebook_" +
                                                        System.currentTimeMillis();
                                ...
                                mytiktok_get_thread = new Thread() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            ...
                                            Request request = new Request.Builder()
                                                    .url("https://dowmate.com/api/allinone/")
                                                    .method("POST", body)
                                            ...
                                            DownloadFileMain.startDownloading(Mcontext, document.getJSONObject("data").getString("url"), nametitle, ".mp4");
...
//                System.out.println("myresponseis111 exp177 " + document.select("video[src]").first().attr("src"));
    ...
    public static class callGetsnackvideoData extends AsyncTask<String, Void, Document> {
        ...
        protected Document doInBackground(String... urls) {
            try {
                ...
                RequestBody body = new MultipartBody.Builder().setType(MultipartBody.FORM)
                        .addFormDataPart("ic-request", "true")
                        .addFormDataPart("id", urls[0])
                        .addFormDataPart("ic-element-id", "main_page_form")
                        .addFormDataPart("ic-id", "1")
                        .addFormDataPart("ic-target-id", "active_container")
                        .addFormDataPart("ic-trigger-id", "main_page_form")
                        .addFormDataPart("token", "99e5b53ce934288ec8d1b83a414fd7cal136e2ba79e24f7f595e87568b9dbbd87")
                        .addFormDataPart("ic-current-url", "/")
                        .addFormDataPart("ic-select-from-response", "#id9ec35b")
                ...
                Request request = new Request.Builder()
                        ...
                        .addHeader("x-ic-request", "true")
                        .addHeader("x-requested-with", "XMLHttpRequest")
                        .addHeader("Cookie", "PHPSESSID=gd9k8u2cuhs9rto5pcrmmldbqn; lang=en")
                        .build();
                Response response = client.newCall(request).execute();
                snackvideoDoc = Jsoup.parse(response.body().string());
        ...
        @Override
        protected void onPostExecute(Document result) {
            System.out.println("myresponseis111 list_of_qualities" + result);

            try {
                Elements elements = result.select("a");
                for (Element element : elements) {

                    if (element.attr("href").contains("/dl?url=http")) {

                        VideoUrl = "https://getsnackvideo.com" + element.getElementsByTag("a").attr("href");
...
//                }
    ...
    public static class CallkuaishouData extends AsyncTask<String, Void, Document> {
        ...
        public Document doInBackground(String... strArr) {
            try {
                System.out.println("mybodyhh1111>>> " + strArr[0]);
