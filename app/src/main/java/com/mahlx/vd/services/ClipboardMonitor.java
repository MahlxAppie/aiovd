...
public class ClipboardMonitor extends Service {
            ...
            new ClipboardManager.OnPrimaryClipChangedListener() {
                ...
                public void onPrimaryClipChanged() {
                    try {
                        ...
                        if (newClip != null && !newClip.equals("")) {
    ...
    private void startInForeground() {
        ...
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_ONE_SHOT);
    ...
    public PendingIntent makePendingIntent(String name) {
        ...
        return PendingIntent.getService(getApplicationContext(), 0, intent, PendingIntent.FLAG_IMMUTABLE | PendingIntent.FLAG_ONE_SHOT);
    }
